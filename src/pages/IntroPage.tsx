...
const IntroPage = (props: Props) => {
  return (
    <div>
      ...
      <div className="text-black relative z-10 ml-12 pb-10 h-24 font-bold">Compete with others in the Experience Box and <br/> predict how the match will turn out.</div>
      <div className="flex relative z-10 ml-10 py-2">
        ...
        <Link to="/" style={{display: "flex", alignItems: "center", color: "#EA0000"}}><FiCircle className="text-3xl mx-2 fill-[#EA0000]"/></Link>
        ...
        <Link to="/intro1" style={{display: "flex", alignItems: "center", color: "#EA0000"}}><FiChevronRight className="text-3xl mx-2"/></Link>
      </div>
    </div>
